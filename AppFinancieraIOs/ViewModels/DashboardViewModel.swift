...
class DashboardViewModel: ObservableObject {
    ...
    func loadRecentIncome() {
        ...
        recentIncome = [
            Income(grossAmount: 25000, netAmount: 21328, date: Date(), type: .freelance, description: "Proyecto web"),
            Income(grossAmount: 15000, netAmount: 12799, date: Calendar.current.date(byAdding: .day, value: -7, to: Date()) ?? Date(), type: .freelance, description: "Consultoría")
        ]
    }
